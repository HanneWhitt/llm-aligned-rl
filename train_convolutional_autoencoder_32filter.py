...
for epoch in range(num_epochs):
    ...
    ls = loss.item()
    lses.append(ls)
    np.savetxt("../autoencoder_samples/32_filter/loss_record.csv", lses, delimiter=",")
    ...
    if ls < min_loss:
        ...
        if epoch % 5== 0 or epoch > 50:
           save_top_example(img, f'../autoencoder_samples/32_filter/epoch_{epoch}_original.png')
           save_top_example(output, f'../autoencoder_samples/32_filter/epoch_{epoch}_reconstructed.png')
